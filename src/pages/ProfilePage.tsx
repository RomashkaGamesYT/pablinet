...
import { Calendar, Palette, Heart, MessageCircle, Share2 } from "lucide-react";
            ...
            <div className="flex items-start justify-between gap-3">
              <div className="flex flex-col gap-1 min-w-0">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" className="shrink-0 drop-shadow-[0_2px_6px_rgba(0,128,255,0.35)] text-primary" aria-label="Подтверждённый аккаунт">
              ...
              <button
                onClick={startEdit}
                className="bg-primary hover:opacity-90 text-primary-foreground px-3 sm:px-4 py-2 rounded-full text-xs sm:text-sm font-medium transition-all duration-200 active:scale-95 shadow-[0_2px_8px_rgba(255,255,255,0.15)] ring-1 ring-inset ring-black/5 shrink-0"
              >
                Редактировать
              </button>
            </div>
          ...
          <div className="flex flex-col gap-4">
            {displayPosts.length === 0 ? (
              ...
              displayPosts.map((post: any) => {
                ...
                return (
                  <div key={post.id} className="bg-card/50 rounded-3xl p-4 sm:p-5 ring-1 ring-border transition-colors hover:bg-card/80">
                    <div className="flex items-center gap-3 mb-3">
                      <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-gradient-to-tr from-net-cyan/20 to-net-emerald/20 flex items-center justify-center ring-1 ring-input">
