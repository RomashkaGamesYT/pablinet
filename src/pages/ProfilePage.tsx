            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex flex-col gap-1.5">
                <h1 className="text-xl font-semibold tracking-tight text-primary flex items-center gap-2">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" className="shrink-0 drop-shadow-[0_2px_6px_rgba(0,128,255,0.35)] text-primary" title="Подтверждённый аккаунт">
